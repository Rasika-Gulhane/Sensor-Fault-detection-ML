...
class TrainPipeline:
    ...
    def start_model_evaluation(self, data_validator_artifact: DataValidationArtifact, 
                               model_trainer_artifact: ModelTrainerArtifact):
        try:
            model_evaluation_config = ModelEvaluationConfig(self.training_pipeline_config)
            model_evaluation = ModelEvaluation(model_evaluation_config, data_validator_artifact, model_trainer_artifact
            )
    ...
    #sync artifact and saved model directory to AWS bucket s3 url 
